This is the Fundraising Platform frontend built with Next.js. Configure the API base URL to connect to your FastAPI backend.

## Getting Started

First, create `.env.local` and set:
